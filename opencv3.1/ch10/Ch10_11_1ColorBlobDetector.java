...
public class Ch10_11_1ColorBlobDetector {
    ...
    public void ColorBlobDetector() {
    	 ...
    	 Mat source =Imgcodecs.imread("C://opencv3.1//samples//DSC_0724.jpg",Imgcodecs.CV_LOAD_IMAGE_COLOR);
        ...
        setHsvColor(mBlobColorHsv);
           ...
           process(source);
            ...
            Imgcodecs.imwrite("C://opencv3.1//samples//colorBlobdector1.jpg", source);
